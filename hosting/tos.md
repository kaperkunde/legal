...
- **Plan Details** shown on the order page, proposal, invoice, or plan description
- the [Privacy Policy](../privacy.md)
- the [Acceptable Use Policy](aup.md) (“**AUP**”)
...
A custom written agreement overrides these online Terms only where it clearly says so.
...
- HTTPS/SSL for custom domains where supported
...
These Terms apply to customers who buy or use the Service, including businesses, sole proprietors, organizations, and consumers aged 18 or older.

If you use the Service on behalf of a company or organization, you confirm that you have authority to accept the Agreement for that entity.

---

## 5. Account eligibility and responsibility

You must provide accurate account, billing, and contact information and keep it current.

You are responsible for all activity under your account, securing login credentials, using strong passwords and two-factor authentication where available, promptly reporting suspected compromise, and ensuring your users, staff, contractors, and contributors comply with the Agreement.

Losses caused by your failure to secure your account or devices are your responsibility.

Creating an account or contacting us may result in service-related communications about your account, billing, security, or the Service. Where permitted by law, we may also send occasional product news; you may opt out of non-essential marketing email as described in the [Privacy Policy](../privacy.md).
...
Ghost and other open-source or third-party software used in the Service remain subject to their own licenses. Ghost is open-source software released under the MIT license. You are responsible for complying with applicable third-party license terms for themes, plugins, and integrations you choose to use.

### 6.4 Your IP obligations

You are solely responsible for ensuring Customer Content, themes, plugins, integrations, and your use of the Service do not infringe or misappropriate third-party intellectual-property or other rights.

---

## 7. Customer responsibility for content and compliance
...
You must comply with the [AUP](aup.md), which is incorporated into the Agreement.
...
- supporting evidence reasonably needed to identify the content or issue
...
## 13. Memberships, payments, and Stripe
...
Refund requests from your readers or members should be directed to you.
...
## 15. Custom code, themes, plugins, and integrations

Custom themes, plugins, code, scripts, integrations, and third-party services are allowed only where supported by Plan Details and the hosted platform.
...
Backups are a safety measure, not a guarantee. You remain responsible for keeping independent copies of important content, exports, files, databases, and business records.

One reasonable restore is included for provider-caused issues. Customer-requested restores may be billed, limited, delayed, or unavailable depending on backup availability, technical feasibility, account status, and the nature of the request.

Data-loss liability limits are in §30.

---

## 18. Export and deletion

While your account is active and paid up, you may request or export your content and database where technically available.

After termination, cancellation, trial expiry, or non-payment, Customer Content may be deleted after **30 days**. Free, trial, or abandoned sites may be suspended or deleted after **30 days** from expiry or non-payment.

You may request earlier deletion, subject to legal, accounting, security, dispute, and backup-cycle limitations. Deleted content may remain temporarily in backups until those backups expire or are overwritten.
...
Support is provided by email or support form on a best-effort basis. Typical targets are **1–2 business days** on Dutch business days, excluding Dutch public holidays.

Support covers operating the hosted platform. Unless separately agreed in writing, it excludes custom development, content or marketing work, third-party integrations, malware cleanup caused by customer actions, recovery from unsupported modifications, and legal, tax, privacy, or regulatory advice.

Occasional help with excluded items does not create an ongoing obligation to provide that help again.

---

## 21. Resource limits and fair use
...
## 22. Billing, subscriptions, and taxes

Services are billed monthly or annually in advance unless otherwise agreed in Plan Details. Prices include VAT unless clearly stated otherwise.

For business customers, subscriptions renew automatically unless cancelled before renewal. For consumers, renewal and cancellation rights apply as required by mandatory consumer law.
...
The Service may depend on third-party providers such as those listed in the [Subprocessor List](subprocessors.md), plus domain registrars, payment processors you enable, themes, plugins, and other software vendors.

Your use of third-party services is at your own risk. You are responsible for third-party fees unless Plan Details clearly say they are included. Third-party failures are excluded from liability under §30.
...
Each party must protect the other party’s non-public business, technical, account, security, and commercial information using reasonable care.
...
## 30. Indemnity, disclaimers, and limitation of liability
...
**Entire agreement.** The Agreement is the entire agreement between the parties regarding the Service and supersedes prior discussions on the same subject, except a custom written agreement that clearly overrides these Terms.

**Severability.** If any provision is invalid or unenforceable, the remaining provisions remain in effect.

**No waiver.** Failure to enforce a provision is not a waiver of that provision or any other provision.

**Survival.** Provisions that by nature should survive termination — including Customer Content ownership, confidentiality, indemnity, disclaimers, liability limits, payment obligations, privacy and data-protection terms, and dispute terms — survive termination.
...
Privacy practices for data Kaperkunde controls as an independent controller are in the [Privacy Policy](../privacy.md). Roles, subprocessors, and customer responsibilities for hosted data are summarized there and detailed below.
...
Depending on your use, hosted personal data may include website user data, names, email addresses, usernames, profile information, comments, newsletter or membership data, IP addresses, logs, device or browser data, visit or traffic data stored for your site, payment or subscription metadata processed through your hosted platform, and any other personal data you upload or collect.

Data subjects may include your staff, contractors, visitors, members, subscribers, commenters, and other people whose data is included in Customer Content.

## A4. Duration

Processing continues for the duration of the Service and afterward only as needed for deletion, export, backup expiry, legal obligations, security, disputes, and accounting, as described in §18 and the [Privacy Policy](../privacy.md).
...
## A13. Customer responsibilities

You are responsible for having a lawful basis for processing, providing required privacy and cookie notices, handling consent where required, responding to data-subject requests for your end users, configuring your site lawfully, and deciding what personal data is collected, stored, retained, or deleted.

Further detail is in the [Privacy Policy](../privacy.md) and [AUP](aup.md).
