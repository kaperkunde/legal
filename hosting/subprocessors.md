...
This list identifies subprocessors plek.je uses to provide managed hosting services where Kaperkunde acts as a **processor** on your behalf under the [Data Processing Terms](tos.md#appendix-a-data-processing-terms) in our Terms of Service.

Subprocessors Kaperkunde uses as a **controller** — including **Stripe** for hosting subscription payments — are listed in the [Privacy Policy](../privacy.md#51-when-kaperkunde-is-controller).
...
plek.je may add or replace subprocessors as needed to operate the Service.

Where required by applicable data-protection law, plek.je will provide reasonable notice of material changes and allow you to object on reasonable data-protection grounds as described in [Appendix A](tos.md#appendix-a-data-processing-terms) of the Terms of Service.
